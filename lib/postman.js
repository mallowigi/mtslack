...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const cssPath = 'http://10.100.102.2:8030/dist/slack.css';
      ...
      return ((e) => {
        ...
        function f(e, t, s, l) {
          ...
          function b(e) {
            ...
            return (
              s.starts && (s.endSameAsBegin && (s.starts.endRe = s.endRe), h(s.starts)), a.returnEnd ? 0 : n.length
            );
          }
        ...
        function x(e) {
          ...
          const n = ((e) => {
            ...
            if (n) {
              const t = N(n[1]);
              return (
                t || (U(o.replace('{}', n[1])), U('Falling back to no-highlight mode for this block.', e)),
                t ? n[1] : 'no-highlight'
              );
            }
          ...
          Object.assign(e, {
            ...
            fixMarkup: (e) => {
              return (
                ...
                z('10.2.0', 'Please see https://github.com/highlightjs/highlight.js/issues/2534'),
                (t = e),
